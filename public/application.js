...
var config = {
  apiOrigins: {
    ...
    production: 'https://grubbableawesome.herokuapp.com'
  }
};
...
var onUpdateInfo = function onUpdateInfo(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateInfo(data).then(ui.updateInfoSuccess).catch(ui.updateInfoFailure);
};
...
var onGetSingleUser = function onGetSingleUser(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.seeOneUser(data).then(ui.singleUserSuccess).catch(ui.singleUserFaliue);
};
var onGetAllUser = function onGetAllUser(event) {
  event.preventDefault();
  api.seeAllUser().then(ui.GetAllUserSuccess).catch(ui.GetAllUserFaliure);
};
var onStatusPost = function onStatusPost(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.statusPost(data).then(ui.statusPostSuccess).catch(ui.statusPostFaliure);
};
var onSeeStatus = function onSeeStatus(event) {
  event.preventDefault();
  api.seeStatus().then(ui.seeStatusSuccess).catch(ui.seestatusFaliure);
};

var onAddFriend = function onAddFriend(event) {
  event.preventDefault();
  var data = $(event.target).parent().parent().attr('data-id');
  api.addFriend(data).then(ui.addFriendSuccess).catch(ui.addFriendFaliure);
};

var onAboutfriend = function onAboutfriend(event) {
  event.preventDefault();
  var id = $(event.target).parent().parent().attr('data-id');
  console.log(id);
  api.aboutFriend(id).then(ui.aboutFriendSuccess).catch(ui.aboutFriendFaliure);
};
...
var seeOneUser = function seeOneUser(data) {
  return $.ajax({
...
var seeAllUser = function seeAllUser() {
...
var statusPost = function statusPost(data) {
  return $.ajax({
...
var seeStatus = function seeStatus() {
  return $.ajax({
    url: config.apiOrigin + '/statuses',
    method: 'GET',
    headers: {
...
var aboutFriend = function aboutFriend(id) {
  console.log(id);
  return $.ajax({
...
var store = __webpack_require__(6);
var showStatusTemplate = __webpack_require__(17);
var showSingleUserTemplate = __webpack_require__(34);
var showAboutUserTemplate = __webpack_require__(35);
...
var singleUserSuccess = function singleUserSuccess(data) {
  console.log(data);
  $('#display-user').show();
  $('.head1').show();
  var showSingleUserHtml = showSingleUserTemplate({ user: data.user });
  $('#addUser').append(showSingleUserHtml);
  console.log(showSingleUserHtml + 'checking handlebars');
};
var GetAllUserSuccess = function GetAllUserSuccess(data) {
  console.log(data);
};
var GetAllUserFaliure = function GetAllUserFaliure(error) {
  console.log(error);
};
var statusPostSuccess = function statusPostSuccess(data) {
  console.log(data);
  var showStatusHtml = showStatusTemplate({
    status: data.status
  });
...
var seeStatusSuccess = function seeStatusSuccess(data) {};

var statusPostFaliure = function statusPostFaliure(error) {
  console.log(error);
};
...
var aboutFriendSuccess = function aboutFriendSuccess(data) {
  console.log(data);
  var showAboutUserHtml = showAboutUserTemplate({
    user: data.user
  });
...
module.exports = {
  ...
  statusPostSuccess: statusPostSuccess,
  statusPostFaliure: statusPostFaliure,
  GetAllUserSuccess: GetAllUserSuccess,
  GetAllUserFaliure: GetAllUserFaliure,
  seeStatusSuccess: seeStatusSuccess,
  singleUserSuccess: singleUserSuccess,
  addFriendSuccess: addFriendSuccess,
  aboutFriendSuccess: aboutFriendSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div id ='tog' data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.status : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n\n<p name=\"[status][status]\"> <strong> status:"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.status : depth0)) != null ? stack1.status : stack1), depth0))
    + "</strong></p>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<tr data-id=\""
    ...
    + "\">\n  console.log(data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.id : stack1), depth0))
    + "\")\n  <td name=\"[credentials][name]\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.name : stack1), depth0))
    + "</td>\n  console.log(\"[credentials][name]\")\n  <td><button id=\"aboutUser"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-default aboutUser\">ABOUT</button></td>\n  <td><button id=\"followUser"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-default followUser\">Add-Friend</button></td>\n</tr>\n";
},"useData":true});
